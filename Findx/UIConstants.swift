...
struct UIConstants {
    struct colors {
        static let background = UIColor(hexString:"#1e93d1")
        static let customWhite = UIColor(hexString:"#f2f5f7")
        static let backgroundSettings = UIColor(rgb: 0x221F1F)
        ...
        static let urlTextHighlight = UIColor(hexString:"#1e93d1") 
