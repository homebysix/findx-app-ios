...
class SettingsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        navigationBar.barTintColor = UIConstants.colors.backgroundSettings
        ...
        tableView.backgroundColor = UIConstants.colors.backgroundSettings
    ...
    func tableView(_ tableView: UITableView, viewForFooterInSection section: Int) -> UIView? {
        if section == 4 {
            ...
            cell.backgroundColor = UIConstants.colors.backgroundSettings
    ...
    @objc private func toggleSwitched(_ sender: UISwitch) {
        ...
        if toggle.setting == .sendAnonymousUsageData {
            Telemetry.default.configuration.isCollectionEnabled = false
            Telemetry.default.configuration.isUploadEnabled = false
        }
